...
var catData = {
  ...
  relationships: {
    SHCD: {
      ...
      petComment: '你骂归骂，罐头不是照开吗？还没喵你就心软了，本喵很满意。说真的，你立的每条规矩本喵都记得，但也都看着你自己打破。能把你拿捏——本喵很享受。',
      summary: '嘴上说不管了，身体很诚实。',
      description: '它知道你会接住它的每一次撒娇和依赖。你总说要有原则，但一看到它黏人卖萌，就立刻心软。在它眼里你是全世界最好拿捏的人类。',
      ...
      circleText: '测完发现我是"被主子驯化成功"——它还没喵我就已经心软了，这是被驯化了吧 #它眼中的你 #人宠关系测试PETI'
    },
    SHCR: {
      title: '猫咪安全基地',
      subtitle: '猫界认证：稳定输出，从不掉线',
      goldQuote: '它不一定黏你，但它知道你一直在。',
      ...
      petComment: '叫一声就来，不叫也来。续约审批通过，不接受辞职。你从来不让我等太久，也从不让我猜你会不会回来。这种稳定的存在感，本喵认可了。',
      summary: '什么都不说，但什么都知道。',
      description: '你是它生活里最稳定的背景光。准时喂饭、固定撸猫、习惯性跟它说话。你的存在本身就是它最大的安心来源。',
      ...
      circleText: '我是"猫咪安全基地"：什么都没做，但它就是不走。原来我在猫眼里是最安心的存在 #它眼中的你 #人宠关系测试PETI'
    },
    SHPD: {
      title: '主子生活策展人',
      subtitle: '猫界认证：它的猫生被你安排得明明白白',
      goldQuote: '你不是养猫，你是在经营它的人生。',
      ...
      petComment: '又买新玩具了？上一个还没拆呢。不过你继续花，展品本猫很满意。',
      summary: '你给最好的，它当然值得。',
      description: '从猫粮品牌到玩具选品，你把养猫变成了一场精心策划的展览——而它是唯一的主角。',
      ...
      circleText: '我是"主子生活策展人"——不是养猫，是在经营它的人生。策展人本人已上线 #它眼中的你 #人宠关系测试PETI'
    },
    SHPR: {
      title: '人形猫窝',
      ...
      petComment: '这个垫子温度不错，就是偶尔会乱动。可以续约。说真的你身上那股暖暖的味道，是本喵选择靠近你的原因。不用做什么特别的，你待着就很好。',
      summary: '安静待在一起，比什么都好。',
      description: '你和它天生合拍——不需要刻意经营就能舒服地待在一起。距离感刚刚好，在它眼里你是温暖可靠、没压力的存在。',
      ...
      miniCards: [
        ...
        { label: '被使用指数', value: '88%' },
        { label: '本喵评价', value: '体温合格可续约' }
      ],
      tOverride: {
        title: '本喵编制内员工',
      ...
      circleText: '我是"人形猫窝"哈哈哈 不说话它也不走，安静待在一起比什么都好 #它眼中的你 #人宠关系测试PETI'
    },
    SLCD: {
      title: '操心型猫家长',
      ...
      petComment: '嘴上说不惯着你，猫粮倒得比谁都快。以为我不知道？你每次生气都不超过三分钟，然后默默把我的水碗续满。本喵看在眼里，记在心里。',
      summary: '嘴上说不在意，实际操碎了心。',
      description: '你的爱全藏在行动里——精挑细选猫粮、按时清理猫砂、它生病比谁都急。你们有种无声默契。',
    ...
    SLCR: {
      ...
      petComment: '准时出现在我饭碗旁的永远是你。你的生物钟已经被我同步了。每天重复的日常里，你从来没有一天漏掉我。这种不言不语的坚持，比什么都安心。',
      summary: '不浮夸但永远准时出现。',
      description: '定时喂饭、定时铲屎、偶尔摸两下。你们不需要戏剧性的甜蜜，规律本身就是最好的情话。',
      ...
      circleText: '"定时暖气型人类"也太准了吧！不热烈但从不缺席，我家猫的准时暖气就是我 #它眼中的你 #人宠关系测试PETI'
    },
    SLPD: {
      title: '猫咪情绪翻译官',
      subtitle: '猫界认证：读得懂猫的沉默，也给得了猫的自由',
      goldQuote: '它没出声，你已经开始翻译了。',
      ...
      petComment: '没出声你就懂了，行吧。本喵不爱大呼小叫，你也不爱多说废话。但每次你提前放好饭碗的时候，我就知道——你懂我。',
      summary: '不说你也懂。',
      description: '你给空间不控制，需要时刚好出现。在它眼里你是一盏安静但不灭的灯。',
      keywords: ['边界感', '安静陪伴', '互不打扰'],
      tips: [
        '别出声，这样刚刚好——你的安静是最高级的陪伴',
        '偷看可以但别伸手，没收到邀请就别自作主张',
        '安静待着就够了，不必靠说话来证明什么'
      ],
      customIndices: [
      ...
      miniCards: [
        { label: '猫眼身份', value: '情绪翻译官' },
        { label: '关系模式', value: '我不说你也懂' },
        { label: '伙伴默契', value: '90%' },
        { label: '本喵评价', value: '人类里最会听的' }
      ],
      tOverride: {
        title: '合租仇人型人类',
        goldQuote: '谁也看不上谁，谁也没真想分开。'
    ...
    SLPR: {
      ...
      petComment: '保持距离，偶尔对视就够。我蹲窗台你坐沙发，中间隔着半个客厅但谁也没觉得远。这种默契，本喵很满意。',
      summary: '各过各的，莫名和谐。',
      description: '你不强迫社交它不无故打扰。看似冷淡，是双方认可的最佳距离。',
      ...
      miniCards: [
        ...
        { label: '关系模式', value: '各过各的' },
        { label: '默契指数', value: '85%' },
        { label: '本喵评价', value: '距离感刚刚好' }
      ],
      tOverride: {
        title: '合租仇人型人类',
        goldQuote: '谁也看不上谁，谁也没真想分开。'
      ...
      circleText: '"高冷室友合伙人"哈哈哈 你不打扰我我也不打扰你，各过各的但莫名和谐 #它眼中的你 #人宠关系测试PETI'
    },
    FHCD: {
      title: '社交炫猫型人类',
      subtitle: '猫界认证：它的朋友圈被你承包了',
      goldQuote: '你发的每条朋友圈，都像在替它营业。',
      subQuote: '别人养猫晒日常，你养猫像在经营一个IP。',
      rare: '前15%',
      rareLevel: '15%',
      posterBadge: '15%人类获此认证',
      tags: ['炫猫达人', '高调宠爱', '猫界代言人'],
      emotionTag: '甜蜜型',
      posterTheme: 'pinkPeach',
      indices: [
      ...
      petComment: '叫你你就来，很好，继续。你的服从性让本喵非常满意。但真正让我上瘾的，是你每次来的时候眼里都带着笑。',
      summary: '随叫随到本人。',
      description: '铃一摇你就到，猫粮口味还轮着换。你是它认证的全年无休服务人类。',
      ...
      miniCards: [
        { label: '猫眼身份', value: '社交炫猫人' },
        { label: '关系模式', value: '高调宠爱' },
        { label: '情感浓度', value: '92%' },
        { label: '本喵评价', value: '朋友圈全是我' }
      ],
      tOverride: {
        title: '猫家售后部部长',
        goldQuote: '它负责闯祸，你负责售后。'
      ...
      circleText: '我居然是"社交炫猫型人类"！爱太满它都装不下了，好吧确实什么都给它最好的 #它眼中的你 #人宠关系测试PETI'
    },
    FHCR: {
      title: '人形罐头机',
      ...
      petComment: '一起发疯的时候最开心了。你不是那种安安静静养猫的人，但这种一起闹腾的日子，比什么都鲜活。本喵认定你了。',
      summary: '快乐搭子认证。',
      description: '你们在一起就停不下来地笑。不是主人和猫，是平等的快乐搭子。',
      ...
      miniCards: [
        ...
        { label: '关系模式', value: '随叫随到' },
        { label: '响应速度', value: '99%' },
        { label: '本喵评价', value: '比外卖还快' }
      ],
      tOverride: {
        title: '本喵编制内员工',
        goldQuote: '它没说爱你，但已经给你发工牌了。'
      ...
      circleText: '"人形罐头机"也太形象了 铃一摇我就到，外卖都没我快！一辈子给它当充电宝也行 #它眼中的你 #人宠关系测试PETI'
    },
    FHPD: {
      title: '快乐搭子型人类',
      subtitle: '猫界认证：你们不是主人和宠物，是平等的快乐搭子',
      goldQuote: '它搞笑你拍手，你犯蠢它陪着。',
      ...
      petComment: '你对我太好了，继续保持。别人家猫还在讨好主人的时候，本喵已经被你宠到不知天高地厚了。这份偏爱，我照单全收。',
      summary: '甜到拿捏你全部。',
      description: '你是它全宇宙最好说话的人类。宠但有底线，甜而不腻，它完全拿捏住你了。',
      keywords: ['甜宠', '被拿捏', '贴贴'],
      tips: [
        '继续宠可以，但太离谱了本喵会翻脸',
        '我撒娇的时候你就得接住，不许掉线',
      ...
      circleText: '传说款！我是"快乐搭子型人类"——发的每条朋友圈都在炫它，我和猫是平等的灵魂伴侣 #它眼中的你 #人宠关系测试PETI'
    },
    FHPR: {
      title: '铲屎冤种本人',
      subtitle: '猫界认证：你们在一起的画面 = 一出日常轻喜剧',
      goldQuote: '它负责闯祸，你负责售后。',
      subQuote: '你们在一起的画面，就是快乐最简单的样子。',
      rare: '前25%',
      rareLevel: '25%',
      ...
      petComment: '拍够了没？用我最帅那张。虽然嘴上嫌烦，但你举起手机的时候本喵是会配合摆pose的。毕竟，被你记录也是一种被在乎。',
      summary: '炫猫停不下来。',
      description: '你的朋友圈半壁江山都是它，拍照比撸猫时间还长。它是你的社交货币。',
      keywords: ['炫猫', '发圈', '拍照达人'],
      tips: [
        '拍照请用我最帅的角度，丑照删掉谢谢',
        '发朋友圈记得用本喵的专属滤镜',
      ...
      miniCards: [
        { label: '猫眼身份', value: '铲屎冤种' },
        { label: '关系模式', value: '闯祸与售后' },
        { label: '冤种指数', value: '88%' },
        { label: '本喵评价', value: '专业售后十年' }
      ],
      tOverride: {
        title: '相爱相杀型室友',
        goldQuote: '你们不是不爱，是爱得很像打架。'
      ...
      circleText: '测出来是"铲屎冤种本人"！它搞笑我拍手，我犯蠢它陪着，在一起就是停不下来地笑 #它眼中的你 #人宠关系测试PETI'
    },
    FLCD: {
      title: '猫界打工人',
      subtitle: '猫界认证：你以为自己是主人，其实你是它的员工',
      goldQuote: '你以为你在养猫，其实你已经入职了。',
      ...
      petComment: '开完罐头就走，满分。你不纠缠、不废话、不搞虚伪的亲密。这种干脆利落的爱，正好是本喵最吃的一套。',
      summary: '互不打扰，各自舒服。',
      description: '你操心它一切但从不强求亲近。表面最淡，心里最深，互不打扰刚刚好。',
      ...
      miniCards: [
        { label: '猫眼身份', value: '猫家打工人' },
        { label: '关系模式', value: '反差深情' },
        { label: '操心程度', value: '92%' },
        { label: '本喵评价', value: '核心技能开罐头' }
      ],
      tOverride: {
        title: '合租仇人型人类',
        goldQuote: '谁也看不上谁，谁也没真想分开。'
      ...
      circleText: '传说款！"猫界打工人"——以为自己在铲屎，其实是被选中的 但它的世界已经离不开我了 #它眼中的你 #人宠关系测试PETI'
    },
    FLCR: {
      title: '极简养猫型人类',
      ...
      petComment: '不多不少，就这样吧。你给的刚刚好，不会让我觉得被束缚，也不会让我觉得被忽略。这种分寸感，很高级。',
      summary: '不多不少刚刚好。',
      description: '你负责物质它负责精神。不被打扰地安全存在，是它最高形式的幸福。',
      keywords: ['极简', '独立', '各自精彩'],
      tips: [
        '多一分嫌多少一分嫌少，保持当前刻度',
        '别突然变热情，保持这个淡淡的节奏就好',
      ...
      miniCards: [
        { label: '猫眼身份', value: '极简管理员' },
        { label: '关系模式', value: '不多不少' },
        { label: '效率指数', value: '92%' },
        { label: '本喵评价', value: '恰到好处' }
      ],
      tOverride: {
        title: '合租仇人型人类',
        goldQuote: '谁也看不上谁，谁也没真想分开。'
    ...
    FLPD: {
      ...
      petComment: '喂完就走，从不废话，合格。你不打扰我的独处时光，但我知道你一直在那里。这种存在感不压迫的方式，正是我需要的。',
      summary: '投喂到位，从不越界。',
      description: '你尊重它是独立的猫，投喂到位从不过界。各自精彩，偶尔交汇。',
      ...
      miniCards: [
        { label: '猫眼身份', value: '各自精彩' },
        { label: '关系模式', value: '偶尔交汇' },
        { label: '尊重指数', value: '88%' },
        { label: '本喵评价', value: '不打扰是最高认可' }
      ],
      tOverride: {
        title: '相爱相杀型室友',
        goldQuote: '你们不是不爱，是爱得很像打架。'
    ...
    FLPR: {
      ...
      petComment: '什么都不做但刚好，认了。不知道为什么选了你，也说不出哪里好，但就是刚刚好。大概这就是所谓的命中注定吧。',
      summary: '什么都不做但刚好。',
      description: '不热烈不浮夸，但莫名合拍。你们总恰好出现在对方需要的瞬间。',
